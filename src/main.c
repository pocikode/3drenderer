...
void setup(void)
{
  ...
  load_mesh("../assets/f22.obj", "../assets/f22.png", vec3_new(1, 1, 1), vec3_new(-3, 0, 5), vec3_new(0, 0, 0));
  load_mesh("../assets/efa.obj", "../assets/efa.png", vec3_new(1, 1, 1), vec3_new(3, 0, 5), vec3_new(0, 0, 0));
}
